...
function Feed() {
    ...
    useEffect(()=>{
        fetch("http://52.65.227.234:5050/feed",{
            method: "GET",
            headers:{
    ...
    <div>
      <div style={{
        ...
        <br></br><br></br>
       <h1>BlogFeed</h1>
       <h3>A blogging site <i style={{textDecoration: "none", color: "#c8e0e6"}} class="fa fa-pencil" aria-hidden="true"></i></h3>
       <hr></hr> <h6>Made with <span style={{color: "red"}}>&#10084;</span> by &nbsp;<a style={{textDecoration: "none", color: "rgb(237,102,99)", textShadow: "2px"}} href="https://github.com/Varun-D03">Varun</a></h6>
      </div>
